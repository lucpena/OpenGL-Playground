...
std::vector<glm::mat4> PointLight::CalculateLightTransform()
{
	...
	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(1.0f, 0.0, 0.0), glm::vec3(0.0, -1.0, 0.0)));		// + X
	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(-1.0f, 0.0, 0.0), glm::vec3(0.0, -1.0, 0.0) ));		// - X

	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(0.0f, 1.0, 0.0), glm::vec3(0.0, 0.0, 1.0)));		// + Y
	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(0.0f, -1.0, 0.0), glm::vec3(0.0, 0.0, -1.0)));		// - Y

	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(0.0f, 0.0, 1.0), glm::vec3(0.0, -1.0, 0.0)));		// + Z
	lightMatrices.push_back(lightProj * glm::lookAt(position, position + glm::vec3(0.0f, 0.0, -1.0), glm::vec3(0.0, -1.0, 0.0)));		// - Z
